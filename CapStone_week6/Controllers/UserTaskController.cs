...
namespace CapStone_week6.Controllers
{
    public class UserTaskController : Controller
    {
        // GET: UserTask

        UserTaskDBEntities ORM = new UserTaskDBEntities();
        ...
        public ActionResult UserPage(User loginUser)
        {
            ...
            {   
                ...
                {
                    ViewBag.ErrorMessage = "Eamil or Password was incorrect..";
                    return RedirectToAction("Login");
                }
       
               
            }
            ViewBag.ErrorMessage = "There are no users with email address";
            return RedirectToAction("Login");
        ...
        public ActionResult TaskList()
        {
            ...
            ViewBag.taskList = ORM.Tasks.ToList().FindAll(t => t.UserId == user.UserId).ToList();
            return View();
        }
        public ActionResult AddTask(Task newTask)
        {
            ...
            {
                ViewBag.ErrorMessage = "Sthing didn't go right";
        ...
        {
            ORM.Tasks.Find(TaskID).Complete = "True";
            ORM.SaveChanges();
            return RedirectToAction("TaskList");
        }
